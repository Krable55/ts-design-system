...
const Portal = ({ children, target, active, style, className }) => {
  ...
  if (className && portal !== null) portal.className = className;
  if (style && portal !== null) Object.assign(portal.style, style);
  ...
  return <>{active && target && portal ? createPortal(children, portal) : children}</>;
};
